...
Path<-here("Non_Identical_r0","Outputs",params$Model_Path,"OSMAC","Assumed_Model/")

for (j in 1:length(Simulated_Data$All_Models[-1])) 
{
  # Assumed Model j
  load(here(Path,paste0("OSMAC_output_",j,".RData")))
  
  eval(parse(text=paste0("Est_Parameter_AM_",j,"<-rbind.data.frame(Results_OSMAC$mMSE_Output,Results_OSMAC$mVc_Output)")))
  eval(parse(text=paste0("Est_Bias_AM_",j,"<-rbind.data.frame(Bias_OSMAC$mMSE_Output,Bias_OSMAC$mVc_Output)")))
  eval(parse(text=paste0("Utility_AM_",j,"<-rbind.data.frame(Utility_OSMAC$mMSE_Output,Utility_OSMAC$mVc_Output)")))
  
  eval(parse(text=paste0("colnames(Est_Parameter_AM_",j,")<-c('Type','Subsample_Size',paste0('Theta',0:length(Simulated_Data$Theta[-1])))")))
  eval(parse(text=paste0("colnames(Est_Bias_AM_",j,")<-c('Type','Subsample_Size',paste0('Theta',0:length(Simulated_Data$Theta[-1])))")))
  eval(parse(text=paste0("colnames(Utility_AM_",j,")<-c('Type','Subsample_Size','A_optimality','D_optimality')")))
}
...
Est_Parameter<-rbind(data.frame("Model"="Real Model",Est_Parameter_RM),
                     ...
                     data.frame("Model"="Assumed Model 4",Est_Parameter_AM_4),
                     data.frame("Model"="Assumed Model 5",Est_Parameter_AM_5),
                     data.frame("Model"="Assumed Model 6",Est_Parameter_AM_6),
                     data.frame("Model"="Assumed Model 7",Est_Parameter_AM_7),
                     data.frame("Model"="Assumed Model 8",Est_Parameter_AM_8),
                     data.frame("Model"="Assumed Model 9",Est_Parameter_AM_9),
                     data.frame("Model"="Assumed Model 10",Est_Parameter_AM_10),
                     data.frame("Model"="Assumed Model 11",Est_Parameter_AM_11),
                     data.frame("Model"="Assumed Model 12",Est_Parameter_AM_12),
                     data.frame("Model"="Assumed Model 13",Est_Parameter_AM_13),
                     data.frame("Model"="Assumed Model 14",Est_Parameter_AM_14),
                     data.frame("Model"="Assumed Model 15",Est_Parameter_AM_15))
...
Est_Bias<-rbind(data.frame("Model"="Real Model",Est_Bias_RM),
                ...
                data.frame("Model"="Assumed Model 4",Est_Bias_AM_4),
                data.frame("Model"="Assumed Model 5",Est_Bias_AM_5),
                data.frame("Model"="Assumed Model 6",Est_Bias_AM_6),
                data.frame("Model"="Assumed Model 7",Est_Bias_AM_7),
                data.frame("Model"="Assumed Model 8",Est_Bias_AM_8),
                data.frame("Model"="Assumed Model 9",Est_Bias_AM_9),
                data.frame("Model"="Assumed Model 10",Est_Bias_AM_10),
                data.frame("Model"="Assumed Model 11",Est_Bias_AM_11),
                data.frame("Model"="Assumed Model 12",Est_Bias_AM_12),
                data.frame("Model"="Assumed Model 13",Est_Bias_AM_13),
                data.frame("Model"="Assumed Model 14",Est_Bias_AM_14),
                data.frame("Model"="Assumed Model 15",Est_Bias_AM_15))
...
Est_Utility<-rbind(data.frame("Model"="Real Model",Utility_RM),
                   ...
                   data.frame("Model"="Assumed Model 4",Utility_AM_4),
                   data.frame("Model"="Assumed Model 5",Utility_AM_5),
                   data.frame("Model"="Assumed Model 6",Utility_AM_6),
                   data.frame("Model"="Assumed Model 7",Utility_AM_7),
                   data.frame("Model"="Assumed Model 8",Utility_AM_8),
                   data.frame("Model"="Assumed Model 9",Utility_AM_9),
                   data.frame("Model"="Assumed Model 10",Utility_AM_10),
                   data.frame("Model"="Assumed Model 11",Utility_AM_11),
                   data.frame("Model"="Assumed Model 12",Utility_AM_12),
                   data.frame("Model"="Assumed Model 13",Utility_AM_13),
                   data.frame("Model"="Assumed Model 14",Utility_AM_14),
                   data.frame("Model"="Assumed Model 15",Utility_AM_15))

remove(Est_Bias_AM_1,Est_Bias_AM_2,Est_Bias_AM_3,Est_Bias_RM,
       Est_Bias_AM_4,Est_Bias_AM_5,Est_Bias_AM_6,
       Est_Bias_AM_7,Est_Bias_AM_8,Est_Bias_AM_9,
       Est_Bias_AM_10,Est_Bias_AM_11,Est_Bias_AM_12,
       Est_Bias_AM_13,Est_Bias_AM_14,Est_Bias_AM_15,
       Est_Parameter_AM_1,Est_Parameter_AM_2,Est_Parameter_AM_3, Est_Parameter_RM,
       Est_Parameter_AM_4,Est_Parameter_AM_5,Est_Parameter_AM_6,
       Est_Parameter_AM_7,Est_Parameter_AM_8,Est_Parameter_AM_9,
       Est_Parameter_AM_10,Est_Parameter_AM_11,Est_Parameter_AM_12,
       Est_Parameter_AM_13,Est_Parameter_AM_14,Est_Parameter_AM_15,
       Utility_AM_1,Utility_AM_2,Utility_AM_3, Utility_RM,
       Utility_AM_4,Utility_AM_5,Utility_AM_6,
       Utility_AM_7,Utility_AM_8,Utility_AM_9,
       Utility_AM_10,Utility_AM_11,Utility_AM_12,
       Utility_AM_13,Utility_AM_14,Utility_AM_15)

if(params$Model_Path=="Model_1")
{
  Model_Set<-list(c(paste0("Assumed Model ",c(1,15)),"Real Model"),
                      c(paste0("Assumed Model ",2:5),"Real Model"),
                      c(paste0("Assumed Model ",6:10),"Real Model"),
                      c(paste0("Assumed Model ",11:14),"Real Model"))
}

if(params$Model_Path=="Model_2")
{
  Model_Set<-list(c(paste0("Assumed Model ",c(1,15)),"Real Model"),
                      c(paste0("Assumed Model ",2:4),"Real Model"),
                      c(paste0("Assumed Model ",5:10),"Real Model"),
                      c(paste0("Assumed Model ",11:14),"Real Model"))
}
...
```{r Animated Plots}
# Model set 1
Est_Parameter[Est_Parameter$Model %in% Model_Set[[1]],] %>%
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","Oldpara_1.gif"))

# Model set 2
Est_Parameter[Est_Parameter$Model %in% Model_Set[[2]],] %>%
  pivot_longer(starts_with("Theta"), names_to = "Theta", values_to = "Estimated") %>%
ggplot(., aes(x = Estimated, group = as.factor(Model), frame=Subsample_Size,fill=factor(Model))) + 
  geom_histogram(binwidth = 0.02,alpha=0.8)+
  facet_grid(Type~Theta,scales = "free_x",shrink = TRUE)+
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","Oldpara_2.gif"))

# Model set 3
Est_Parameter[Est_Parameter$Model %in% Model_Set[[3]],] %>%
  pivot_longer(starts_with("Theta"), names_to = "Theta", values_to = "Estimated") %>%
ggplot(., aes(x = Estimated, group = as.factor(Model), frame=Subsample_Size,fill=factor(Model))) + 
  geom_histogram(binwidth = 0.02,alpha=0.8)+
  facet_grid(Type~Theta,scales = "free_x",shrink = TRUE)+
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","Oldpara_3.gif"))

# Model set 4
Est_Parameter[Est_Parameter$Model %in% Model_Set[[4]],] %>%
  pivot_longer(starts_with("Theta"), names_to = "Theta", values_to = "Estimated") %>%
ggplot(., aes(x = Estimated, group = as.factor(Model), frame=Subsample_Size,fill=factor(Model))) + 
  geom_histogram(binwidth = 0.02,alpha=0.8)+
  facet_grid(Type~Theta,scales = "free_x",shrink = TRUE)+
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","Oldpara_4.gif"))
```
...
# Model Set 1
Est_Utility[Est_Utility$Model %in% Model_Set[[1]],] %>%
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","OldU_21.gif"))

# Model Set 2
Est_Utility[Est_Utility$Model %in% Model_Set[[2]],] %>%
  ggplot(.,aes(x=log(D_optimality),fill=Model))+
  geom_histogram()+facet_grid(~factor(Type))+
  theme_light()+ylab("Frequency")+xlab("log(D-optimality) ")+
  transition_states(Subsample_Size)+
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","OldU_22.gif"))

# Model Set 3
Est_Utility[Est_Utility$Model %in% Model_Set[[3]],] %>%
  ggplot(.,aes(x=log(D_optimality),fill=Model))+
  geom_histogram()+facet_grid(~factor(Type))+
  theme_light()+ylab("Frequency")+xlab("log(D-optimality) ")+
  transition_states(Subsample_Size)+
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","OldU_23.gif"))

# Model Set 4
Est_Utility[Est_Utility$Model %in% Model_Set[[4]],] %>%
  ggplot(.,aes(x=log(D_optimality),fill=Model))+
  geom_histogram()+facet_grid(~factor(Type))+
  theme_light()+ylab("Frequency")+xlab("log(D-optimality) ")+
  transition_states(Subsample_Size)+
...
include_graphics2(here("Non_Identical_r0","htmloutputs",params$Model_Path,"OSMAC","Plots","OldU_24.gif"))
...
{
  All_MSE[All_MSE$Model %in% Model_Set[[i]],] %>%
  ...
  All_MSE_MLE[All_MSE_MLE$Model %in% Model_Set[[i]],] %>%
    #ungroup(Type,Model,Subsample_Size) %>%
    ggplot(.,aes(x=Subsample_Size,y=MSE,color=Model))+geom_point()+
    geom_line()+scale_colour_viridis_d()+
    theme_light()+xlab("Sub sample size")+facet_wrap(~Type,ncol = 1)+
  ...
  All_VAR[All_VAR$Model %in% Model_Set[[i]],] %>%
    ungroup(Type,Model,Subsample_Size) %>%
  ...
  All_Info[All_Info$Model %in% Model_Set[[i]],] %>%
    ungroup(Type,Model,Subsample_Size) %>%
  ...
  All_Bias[All_Bias$Model %in% Model_Set[[i]],] %>%
    ungroup(Type,Model,Subsample_Size) %>%
  ...
  All_EMSE[All_EMSE$Model %in% Model_Set[[i]],] %>%
    ungroup(Type,Model,Subsample_Size) %>%
  ...
  Accuracy_Data[Accuracy_Data$Model %in% Model_Set[[i]],] %>% 
